          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-5">
            {filteredTravelers ? (
              filteredTravelers.map((traveler) => (
                <div className=" bg-white shadow-lg w-auto xl:w-[375px] flex flex-col justify-between" key={traveler.userId._id}>
                  <div onClick={() => handleClick(traveler?.userId?._id)}>
                    ...
                    <div className="px-2 pb-2 w-auto flex">
                      ...
                      {traveler?.userId?.about ? (
                        ...
                        <p className="leading-4.5 text-xs">About details not provided</p>
                      )}
                    </div>
                  </div>
