    ...
    <nav className="bg-white border-gray-200 navbar">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 ">
        ...
        <div className="flex md:order-1">
          ...
          <div className="search hidden md:block w-auto p-2 text-sm text-gray-900 border border-gray-300 rounded-l-lg bg-gray-50">Find Events</div>
        ...
        {isNavOpen && (
          <div
            ...
            id="navbar-search"
          >
            <ul className="togglenavbar flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white ">
              <li>
                <Link to="/">
                  <a
                    className={`togglenavitem home block py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ${
